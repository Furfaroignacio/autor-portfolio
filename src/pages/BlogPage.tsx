...
function categoryLabel(c: string) {
  // si querés, acá podés traducir/normalizar
...
/>
                ...
                {/* Badge featured tipo UPDATE */}
                <div className="absolute left-4 top-4 flex items-center gap-2">
                  {p.featured ? (
                    <span className="rounded-full bg-[rgb(var(--accent))] px-3 py-1 text-xs font-semibold text-white">
                      UPDATE
                    </span>
                  ) : null}
                </div>
